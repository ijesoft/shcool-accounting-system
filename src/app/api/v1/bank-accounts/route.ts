...
export async function GET() {
  try {
    ...
    return NextResponse.json(formatApiError("ERR_INTERNAL", "Failed to list bank accounts"), { status: 500 })
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json(formatApiError("ERR_INTERNAL", "Failed to create bank account"), { status: 500 })
  }
}
